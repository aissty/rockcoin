...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rockcoin-project/rockcoin>";
    const std::string URL_WEBSITE = "<https://rockcoin.org>";
