...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rockcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rockcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rockcoin transaction") + "\n" +
              "  rockcoin-tx [options] -create [commands]   " + _("Create hex-encoded rockcoin transaction") + "\n" +
              "\n";
