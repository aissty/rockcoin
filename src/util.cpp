...
const char * const BITCOIN_CONF_FILENAME = "rockcoin.conf";
const char * const BITCOIN_PID_FILENAME = "rockcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RockCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/RockCoin";
#else
    // Unix
    return pathRet / ".rockcoin";
#endif
#endif
}
