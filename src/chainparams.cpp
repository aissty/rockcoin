...
{
    const char* pszTimestamp = "Some newspaper headline that describes something that happened today";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1519842888, 748115, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0b3542ae6831053a051890d47c6ae375a244ef7599c10700fbf34e889405d41e"));
        assert(genesis.hashMerkleRoot == uint256S("0x71f68609fc84aa7e78a2f287708d1a8baed062c3cb60d92aa90873b81b0e3753"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.rockcoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("rockcointools.com", "dnsseed.rockcointools.com"));
        //vSeeds.push_back(CDNSSeedData("rockcoinpool.org", "dnsseed.rockcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 409728, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb4aebe1c7198fda0d34d3f786f2a784517b542dbdad14bf2ffeac3a00b4a1f4d"));
        assert(genesis.hashMerkleRoot == uint256S("0x71f68609fc84aa7e78a2f287708d1a8baed062c3cb60d92aa90873b81b0e3753"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("rockcointools.com", "testnet-seed.rockcointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.rockcoin.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfc21e0bd63450a5f47bc98504ca1ad16cecb18d8b366d2ad4c141576af2f4bd4"));
        assert(genesis.hashMerkleRoot == uint256S("0x71f68609fc84aa7e78a2f287708d1a8baed062c3cb60d92aa90873b81b0e3753"));
